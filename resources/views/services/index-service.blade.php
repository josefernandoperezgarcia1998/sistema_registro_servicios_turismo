...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header card-header-primary">
            ...
            <p class="card-category">Listado de servicios registrados en el sistema</p>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $service->person_served }}</td>
                            <td>{{ $service->area }}</td>
                            <td>{{ $service->type_service }}</td>
                            <td class="-b-expander -b-text-undexpanded">{{ $service->description }}</td>
                            <td>{{ $service->personal->name }}</td>
                            <td>{{ $service->date_start_service }}</td>
                            <td>{{ $service->date_end_service }}</td>
                            <td class="text-primary">
                                ...
                                <form action="{{ route('services.destroy', $service->id) }}" method="POST"
                                    ...
                                    onsubmit="return confirm('¿Estas seguro de eliminar este servicio?')">
                                    @csrf
                                    @method('DELETE')
